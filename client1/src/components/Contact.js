...
const Contact = () => {
    ...
    const [userFirstName, setUserFirsName] = useState('');
    ...
    const sendEmail = (e) => {
        ...
        if(userFirstName && userLastName && eMail && message){
            emailjs.send('service_t0dx7ib', 'template_pm1es5j',
                {
                    ...
                    <div className="contact-right">
                        <form className="contact-form" onSubmit={sendEmail}>
                            <div className="contact-row">
                                <input type="text" value={userFirstName} onChange={(e)=>setUserFirsName(e.target.value)} placeholder="First Name" className="contact-input" />
                                <input type="text" value={userLastName} onChange={(e)=>setUserLastName(e.target.value)} placeholder="Last Name" className="contact-input" />
                            </div>
                            <input type="email" value={eMail} onChange={(e)=>setEmail(e.target.value)} placeholder="Email" className="contact-input" />
                            <input type="tel" value={phone} onChange={(e)=>setPhone(e.target.value)}  placeholder="Phone Number" className="contact-input" />
                            <textarea value={message} onChange={(e)=>setMessage(e.target.value)} placeholder="Your Message" className="contact-message"></textarea>
