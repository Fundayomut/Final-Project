...
const AdminUserZeilen = ({ data }) => {
  ...
  const [status, setStatus] = useState(false); // Status, ob das Bearbeitungsformular angezeigt wird
  ...
  const bearbeiten = () => {
    TextAntwort(
      ...
      (antwort) => {
        console.log("user update", antwort); // Erfolg: Benutzeraktualisierung anzeigen
        setStatus(false); // Status zurücksetzen
      },
      (fehler) => {
  ...
  // Initiale Benutzerinformationen setzen
  useEffect(() => {
      ...
      {!status ? (
        <>
          ...
          <div className="admin-user-card-adres">
            <p>
              <span style={{ fontWeight: "bold", color: "gray" }}>Type:</span>
              {type}
            </p>
            <p>
              <span style={{ fontWeight: "bold", color: "gray" }}>Email: </span>
              {eMail}
            </p>
            <p>
              <span style={{ fontWeight: "bold", color: "gray" }}>Phone:</span>
              {phone}
            </p>
            <p>
              ...
              {adresLine1} {adresLine2}
            </p>
          </div>
          <div className="admin-user-card-adres2">
            <p>
              <span style={{ fontWeight: "bold", color: "gray" }}>City:</span>
              {city}
            </p>
            <p>
              <span style={{ fontWeight: "bold", color: "gray" }}>State:</span>
              {state}
            </p>
            <p>
              <span style={{ fontWeight: "bold", color: "gray" }}>
          ...
          <div className="admin-user-zeilen-input-button">
            <button className="button" onClick={HandleStatusTrue}>
              Edit
            </button>
            <button className="button" onClick={entfernen}>
              Delete
            </button>
          </div>
        </>
        ...
        <div className="admin-user-zeilen-input">
          ...
          <div className="admin-user-zeilen-input-button">
            <p>
              <button className="button" onClick={bearbeiten}>
                Change
              </button>
            </p>
            <p>
