    ...
    return (
      <>
        <table>
          ...
          <tr>
       <td><input type='text' defaultValue={userNickName} onChange={(e)=>setUserNickname(e.target.value)}/></td> 
       <td><input  type='text' defaultValue={userFirstName} onChange={(e)=>setUserFirstName(e.target.value)}/></td> 
       <td><input type='text' defaultValue={userLastName} onChange={(e)=>setUserLastName(e.target.value)}/></td> 
       <td><input type='text' defaultValue={userType} onChange={(e)=>setUserType(e.target.value)}/></td> 
       <td><input  type='email' defaultValue={eMail} onChange={(e)=>setEmail(e.target.value)}/></td> 
       <td><input  type='phone' defaultValue={phone} onChange={(e)=>setPhone(e.target.value)}/></td> 
       <td><input  type='text' defaultValue={adresLine1} onChange={(e)=>setAdresLine1(e.target.value)}/></td> 
       <td><input  type='text' defaultValue={adresLine2} onChange={(e)=>setAdresLine2(e.target.value)}/></td> 
       <td><input  type='text' defaultValue={city} onChange={(e)=>setCity(e.target.value)}/></td> 
       <td><input  type='text' defaultValue={state} onChange={(e)=>setState(e.target.value)}/></td> 
       <td><input  type='text' defaultValue={postalCode} onChange={(e)=>setPostalCode(e.target.value)}/></td> 
       <td><input  type='text' defaultValue={country} onChange={(e)=>setCountry(e.target.value)}/></td> 
       <td><input  type='password' defaultValue={password} onChange={(e)=>setPassword(e.target.value)}/></td> 
        </tr>
        </table>
